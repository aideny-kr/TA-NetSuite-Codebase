...
function chargeSalesOrder(internalId) {
	...
	var url = (ENV === 'SANDBOX') ? 'https://rest.sandbox.netsuite.com/app/site/hosting/restlet.nl?script=299&deploy=1':'https://rest.sandbox.netsuite.com/app/site/hosting/restlet.nl?script=299&deploy=1';
