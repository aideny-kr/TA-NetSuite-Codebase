	...
	// Validate Password through taxnotes.com
		...
		if(authToken.hasOwnProperty('access_token') && authToken.hasOwnProperty('token_type')) {
			...
			if(+drupalCode === 200) {
				...
				var url = env == 'SANDBOX' ? 'https://rest.sandbox.netsuite.com/app/site/hosting/restlet.nl?script=257&deploy=1' : 'https://rest.na1.netsuite.com/app/site/hosting/restlet.nl?script=295&deploy=1'; // @TODO: get restlet URL for production
