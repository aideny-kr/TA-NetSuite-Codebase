...
// @TODO: 10/06/2016 Save Record Client Function
...
//		}
		...
		//*** Approved Notification to Sales Rep ***//
		
		if (type == 'edit' && context.getExecutionContext() == 'suitelet' && oldSoid.getFieldValue('custbody_quoteapprovalstatus') == '1' && approvalStatus == '2') {
			var approvedSubject = 'Your Quote has been approved';
			var approvedMsg = nlapiGetFieldText('custbody_nextapprover') + ' has approved your quote for ' + nlapiGetFieldText('entity') + '<br/>';
